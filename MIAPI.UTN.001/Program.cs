...
namespace MiAPI.UTN._001
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //Este bloque se encarga de configurar los servicios necesarios para la aplicación, como el contexto de la base de datos y los controladores. Además, se configura Newtonsoft.Json para manejar las referencias circulares que pueden ocurrir al serializar objetos relacionados, evitando así errores de serialización.
